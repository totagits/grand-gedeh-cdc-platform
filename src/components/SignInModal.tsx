...
export const SignInModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-slate-900 border border-amber-500/50 rounded-2xl max-w-4xl w-full p-6 sm:p-8 shadow-2xl relative my-8">
        ...
        <div className="mb-6 space-y-1">
          <div className="inline-flex items-center space-x-2 text-xs font-bold text-amber-400 uppercase tracking-wider bg-amber-950/60 px-3 py-1 rounded-full border border-amber-800/60">
            ...
            return (
              <div
                ...
                className={`p-4 rounded-xl border cursor-pointer transition-all ${
                  isSelected
                    ? `${rc.accentColor} border-2 shadow-lg ring-1 ring-amber-400/40`
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex items-center space-x-2.5">
                    ...
                    <div>
                      <h4 className="text-xs font-bold text-white leading-tight">{rc.title}</h4>
                      <span className="text-[10px] text-amber-400 font-medium">{rc.samplePerson}</span>
                    </div>
                  </div>
                  <button
                    onClick={(e) => {
                    ...
                    className="text-[10px] bg-amber-500 hover:bg-amber-400 text-slate-950 font-black px-2.5 py-1 rounded-md shadow transition-transform hover:scale-105 shrink-0"
                  >
                    Quick Sign In
                  </button>
                </div>
        ...
        <div className="pt-4 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="text-xs text-slate-400">
            Currently selected: <span className="text-amber-400 font-bold">{DEMO_USERS[selectedRole].name}</span> ({selectedRole.toUpperCase()})
          </div>
          ...
          <div className="flex items-center space-x-3 w-full sm:w-auto">
            <button
              type="button"
              onClick={() => setIsSignInModalOpen(false)}
              className="flex-1 sm:flex-none px-4 py-2 text-xs font-semibold text-slate-300 hover:text-white hover:bg-slate-800 rounded-lg border border-slate-700 transition-colors"
            >
              Cancel
            </button>
            <button
              ...
              className="flex-1 sm:flex-none px-5 py-2 text-xs font-black text-slate-950 bg-gradient-to-r from-amber-500 to-amber-400 hover:from-amber-400 hover:to-amber-300 rounded-lg shadow-lg flex items-center justify-center space-x-2 transition-all hover:scale-105"
            >
