  ...
  return (
    <section className="py-12 bg-slate-900 text-slate-100 min-h-[85vh]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-gradient-to-r from-amber-950/40 via-slate-900 to-emerald-950/40 border border-amber-500/40 rounded-xl p-4 mb-8 text-xs flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center space-x-3">
            <div className="p-2.5 bg-amber-500/20 text-amber-400 rounded-lg">
              <Landmark className="w-5 h-5" />
            </div>
            <div>
              <span className="font-bold text-white text-sm block">President Poah GGAA Diaspora Engagement Alignment</span>
          ...
          <div className="flex items-center space-x-2">
            <span className="bg-emerald-900/60 text-emerald-300 px-3 py-1 rounded-full font-mono text-[11px] border border-emerald-700">
            ...
            >
              <div>
                ...
                <div className="mt-3 p-3 bg-slate-900/80 border border-slate-800 rounded-lg text-xs space-y-1">
                  <div className="text-[10px] text-slate-400 uppercase font-semibold">Specialization Area:</div>
                  <div className="text-slate-200 font-medium leading-relaxed">{exp.specializationArea}</div>
                </div>
              ...
              <div className="mt-5 pt-3 border-t border-slate-700/80 flex items-center justify-between text-xs">
                <div>
                  ...
                  <span className="font-semibold text-emerald-300 truncate max-w-[200px] block">
                    {exp.workingGroupAssigned}
                  </span>
                </div>
                <span className="inline-flex items-center space-x-1 text-[10px] bg-slate-700 text-slate-300 px-2 py-0.5 rounded">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm overflow-y-auto">
            <div className="bg-slate-900 border border-slate-700 rounded-2xl max-w-xl w-full p-6 sm:p-8 shadow-2xl relative my-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 text-xs">
                <div>
                  <label className="block text-slate-300 mb-1 font-medium">Expert Full Name & Title</label>
                  <input
                    type="text"
                    required
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-slate-300 mb-1 font-medium">Primary Discipline</label>
                    <select
                  ...
                  <div>
                    <label className="block text-slate-300 mb-1 font-medium">Highest Academic Degree</label>
                    <input
                      type="text"
                      required
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-slate-300 mb-1 font-medium">Current Institution / Affiliation</label>
                    <input
                      type="text"
                      required
                  ...
                  <div>
                    <label className="block text-slate-300 mb-1 font-medium">Current Location (City & Country)</label>
                    <input
                      type="text"
                      required
                ...
                <div>
                  <label className="block text-slate-300 mb-1 font-medium">Specialization Area & Relevant Experience</label>
                  <textarea
                    required
                    rows={3}
