...
export const ConcessionRegistry: React.FC = () => {
  ...
  return (
    <section className="py-12 bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-100 min-h-[85vh]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Header & Hierarchy Explanation */}
        <div className="mb-8">
          <div className="inline-flex items-center space-x-2 text-xs font-semibold text-emerald-800 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/80 border border-emerald-200 dark:border-emerald-800 px-3 py-1 rounded-full uppercase tracking-wider mb-2">
          ...
          <div className="mt-4 p-3 bg-white dark:bg-slate-800/90 border border-slate-200 dark:border-slate-700 rounded-xl text-xs flex flex-wrap items-center gap-2 text-slate-700 dark:text-slate-300 shadow-sm">
            <span className="font-bold text-amber-800 dark:text-amber-400">Institutional Hierarchy:</span>
            <span className="bg-slate-100 dark:bg-slate-900 px-2 py-0.5 rounded text-slate-900 dark:text-white border border-slate-200 dark:border-slate-700 font-semibold">GGCDC Council</span>
            <ChevronRight className="w-3.5 h-3.5 text-slate-400" />
            <span className="bg-slate-100 dark:bg-slate-900 px-2 py-0.5 rounded text-slate-900 dark:text-white border border-slate-200 dark:border-slate-700 font-semibold">Natural Resources Portfolio</span>
            <ChevronRight className="w-3.5 h-3.5 text-slate-400" />
            <span className="bg-emerald-50 dark:bg-emerald-900/80 text-emerald-800 dark:text-emerald-200 px-2 py-0.5 rounded border border-emerald-200 dark:border-emerald-700 font-semibold">Specialized Sector Arms (8)</span>
            <ChevronRight className="w-3.5 h-3.5 text-slate-400" />
            <span className="bg-amber-50 dark:bg-amber-900/80 text-amber-800 dark:text-amber-200 px-2 py-0.5 rounded border border-amber-200 dark:border-amber-700 font-semibold">Individual Projects (e.g. Putu Iron Ore Working Group)</span>
          </div>
        </div>

        {/* Filter Controls Bar */}
        <div className="bg-white dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 rounded-xl p-4 mb-8 flex flex-col md:flex-row items-center justify-between gap-4 shadow-sm">
          <div className="relative w-full md:w-80">
            ...
            <input
              ...
              className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg pl-9 pr-4 py-2 text-xs text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:border-emerald-500"
            />
          </div>
