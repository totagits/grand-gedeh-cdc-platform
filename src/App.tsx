    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col selection:bg-emerald-700 selection:text-white">
      ...
      <div className="fixed bottom-4 right-4 z-30">
        <button
          ...
          className="bg-slate-900/95 hover:bg-slate-800 text-slate-200 border border-amber-500/80 px-3.5 py-2 rounded-full shadow-2xl flex items-center space-x-2 text-xs backdrop-blur-md transition-transform hover:scale-105"
        ...
        >
          ...
          <span className="text-[11px] text-slate-400 bg-slate-800 px-2 py-0.5 rounded-full border border-slate-700 font-semibold">
